...
<div class="container object-contain">
    ...
    <div>
        ...
        <div class="card-img  text-white text-center -mt-10">
            <img src="{{asset('storage/'.$user->image)}}" alt="" class="img-user rounded-full  h-24 img-fluid  border border-solid border-white-25 mx-auto">
      </div>
...
<div id="myTabContent">
    <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="alamat" class="mt-1 p-2 border rounded w-full focus:ring focus:ring-blue-200"  value="{{ $data_user->addres }}" readonly>
        </div>
        ...
        <a href="{{ url('/profile') }}" class="btn bg-blue-600 w-full text-white">Edit Profile</a>
