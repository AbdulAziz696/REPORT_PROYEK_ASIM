    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form action="{{ url('user/portofolio/add') }}" method="POST"  enctype="multipart/form-data">
                    @csrf
...
<div id="update-porto-modal{{ $user->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                <form action="{{url('user/portofolio/'.optional(auth()->user()->portofolio)->id.'/edit') }}" method="POST"  enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
