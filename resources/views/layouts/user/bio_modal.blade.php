                ...
                <form action="{{ route('data.store') }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="grid gap-6 mb-6 lg:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="first_name" name="nama_pangggilan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Abdul Aziz" required>
                        ...
                        <div>
                            ...
                            <input type="number" id="internship_date" name="waktu_magang" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                            @error('waktu_magang')
                                <p class="text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
