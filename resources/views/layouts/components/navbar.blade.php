             ...
             @else
                 <div class="relative" x-data="{ open: false }">
                     <button @click="open = !open; $nextTick(() => { if(open){ $refs.userMenu.focus() } })" type="button"
                         ...
                         <img class="w-10 h-10 rounded-full" src="img/image_user.png"
                             alt="" />
                     ...
                     <div x-show="open" x-ref="userMenu" x-transition:enter="transition-all transform ease-out"
                         ...
                         <a href="{{ url('user/'.auth()->user()->slug.'/detail') }}" role="menuitem"
            ...
            >
             ...
             <div class="relative ml-auto" x-data="{ open: false }">
                 ...
                 <div x-show="open" x-transition:enter="transition-all transform ease-out"
                     ...
                     x-transition:leave="transition-all transform ease-in"
                     x-transition:leave-start="translate-y-0 opacity-100"
                     x-transition:leave-end="translate-y-1/2 opacity-0" @click.away="open = true"
                     class="absolute right-0 w-48 py-1 origin-top-right bg-black rounded-md shadow-lg top-12 ring-1 ring-black ring-opacity-5 dark:bg-dark"
